              ...
              children: [
                ConstrainedInstance(
                  ...
                  child: Button.text(
                    ...
                    style: ButtonStyle(color: Color.black, hoveredColor: Color.red),
                  ),
                ),
                HappyWidget(const Size(100, 50)),
                HappyWidget(const Size(100, 50)),
                FlexChildInstance(child: HappyWidget(const Size(100, 50))),
                FlexChildInstance(flexFactor: 2, child: HappyWidget(const Size(100, 50))),
              ],
            ),
      ),
    );
                ...
                children: [
                  LayoutAfterTransformInstance(
                    child: TransformInstance(
                      ...
                      child: StencilClipInstance(child: ItGoSpin()),
                    ),
                  ),
                  () {
                              ...
                              ConstrainedInstance(
                                ...
                                child: Button(
                                  child: LabelInstance.text(
                                    text: Text([Icon(icon), Span(' ${icon[0].toUpperCase()}${icon.substring(1)}')]),
                                  ),
                                  onClick: (button) => pages.page = idx,
                                  style: ButtonStyle(color: Color.ofRgb(0x2f2f35), hoveredColor: Color.ofRgb(0x35353b)),
                                ),
                              ),
                          ],
                        ),
...
class ItGoSpin extends SingleChildWidgetInstance with ShrinkWrapLayout {
  ...
  ItGoSpin() : super.lateChild() {
    initChild(_transform = TransformInstance(matrix: Matrix4.identity(), child: HappyWidget(const Size(200, 75))));
  }
